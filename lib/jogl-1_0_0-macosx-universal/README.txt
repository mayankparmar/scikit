...
Java (TM) Binding for the OpenGL (r) API, version 1.0.0
-------------------------------------------------------

This software is licensed by Sun Microsystems, as specified
in the LICENSE-JOGL-v1_0_0.txt file.  You must use this software 
in accordance with the terms under which the code is licensed.



Instructions for unzipping Java Binding for the OpenGL API, v. 1.0.0
--------------------------------------------------------------------
